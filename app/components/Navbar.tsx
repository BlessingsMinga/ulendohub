...
import { interClass } from "../fonts";

export default function Navbar () {


    return (
    <nav className={`${interClass} bg-white shadow-md py-4 border-b border-gray-200`}>
        {""}
        <div className="container mx-auto flex justify-between items-center px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4 gap-6 text-lg" >
                ...
                <button className="flex cursor-pointer item-center justify-center bg-green-700 hover:bg-green-500 text-white p-2 rounded-sm">
                    Sign In
